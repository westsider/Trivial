...
class DataViewModel {
    ...
    var selectedCatagory: Category = .movies
    
    var selectedQuestions: [Trivia]  = []
    
    func seletQuestion(category: Category) {
        switch category {
        case .presidents:
            selectedQuestions = presitentQuestions
        case .usHistory:
            selectedQuestions = presitentQuestions
        case .worldHistory:
            selectedQuestions = presitentQuestions
    ...
    let movieQuestions: [Trivia] = [
        ...
        Trivia(question: "Who stars in top gun", answer: "TOm Cruse", category: .movies),
    ]
